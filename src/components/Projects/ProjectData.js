...
export const ProjectData = [
    ...
    },
    {
        ...
        description: "An eBay like book exchange created using Ruby on Rails where users can lend their used books and other users on the website can rent them for a specified period. Users can also rate the book and accept or decline a rent request. This apps also has user authentication built-in."
